...
final _beEntry = DictEntry(
  ...
  senses: [
    ...
    DictSense(
      pos: 'vt.',
      meanings: DictMeaning.listFromStrings(['做', '成为']),
    ),
    DictSense(
      pos: 'aux.',
      meanings: DictMeaning.listFromStrings(['助动词用法']),
    ),
    DictSense(
      pos: 'n.',
      meanings: DictMeaning.listFromStrings(['字母 B']),
    ),
  ],
  examTags: ['考研', '六级'],
);

final _wasLookupResult = DictLookupResult(
  tappedWord: 'was',
  entry: _beEntry,
  alias: DictAliasMeta(
    lemma: 'be',
...
void main() {
  LookupVariantCard buildCard({
    ...
    return LookupVariantCard(
      lookupResult: lookupResult ?? _wasLookupResult,
